  ...
  <div class="w-full card card-enrolled flex flex-col gap-4.5">
    <div class="flex flex-row items-start justify-between gap-4.5">
      ...
      <div class="flex flex-col justify-between grow gap-2">
        <div class="flex flex-row items-center justify-between">
          <small
            class="text-grayscale-500 text-body-xs text-nowrap capitalize"
        ...
        <div class="flex flex-row items-center gap-2 justify-start">
          ...
          <small
            class="text-helper-regular-m text-[14px] leading-6.5 text-grayscale-500 capitalize"
        ...
        <div class="flex flex-row items-center gap-2 justify-start">
          <IconLoader name="mapPin" class="text-[16px] text-grayscale-600" />
          <small
            class="text-helper-regular-m text-[14px] leading-6.5 text-grayscale-500 capitalize"
    ...
    <div class="flex flex-row items-center justify-between gap-5">
      <div class="flex flex-col w-full gap-2 items-start justify-between pl-1">
        <span
          class="text-body-s leading-6 text-grayscale-900 capitalize"
          v-text="`${data.progress}% complete`"
        />
        <div class="w-full bg-purple-100 rounded-full h-3.75">
          <div
            class="bg-purple-500 h-3.75 rounded-[30px] transform duration-300 transition-all"
