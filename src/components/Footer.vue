...
const { breadCrumbs, separator, socialLinks, footerMenus } = useFooter()
    ...
    <div class="wrapper w-full flex flex-col justify content-between">
      <div class="w-full flex flex-row justify-between">
        <div class="w-full flex flex-col gap-6">
          ...
          <ul
            class="flex flex-row items-center justify-start space-x-5.5 text-purple-400 text-[19px]"
          >
        ...
        <div class="w-full flex flex-row gap-30">
          <div class="w-full flex flex-col gap-4" v-for="section in footerMenus">
            <h3
              class="text-purple-800 text-heading-4 leading-6 capitalize"
            ...
            <ul class="text-grayscale-500 flex flex-col gap-2">
              <li v-for="item in section.menu">
                <AppLink
                  ...
                  :class="[
                    { 'flex flex-row items-center gap-1.5': !!item.icon },
