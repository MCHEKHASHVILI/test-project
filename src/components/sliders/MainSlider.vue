      ...
      <div class="relative h-full w-full flex items-center justify-content-center">
        ...
        <div class="splide__arrows">
          <button class="splide__arrow splide__arrow--prev">
            <IconLoader name="ArrowLeft"
              :class="activeIndex === 0 ? 'rotate-180 text-[54px] text-grayscale-500/50' : 'rotate-180 text-[54px] text-grayscale-50'" />
          </button>
          <button class="splide__arrow splide__arrow--next">
            <IconLoader name="ArrowRight"
              :class="activeIndex === slides.length - 1 ? 'text-[54px] text-grayscale-500/50' : 'text-[54px] text-grayscale-50'" />
          </button>
        </div>
      </div>
    </div>
