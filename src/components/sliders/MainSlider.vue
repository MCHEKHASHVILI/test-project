...
<template>
  <Splide
    :options="options"
    :has-track="false"
    class="relative rounded-[30px] h-105"
    ...
    <div class="absolute top-77.75 w-full flex inset-0">
      <div class="relative h-full w-full flex items-center justify-content-center">
        <div class="absolute inset-0 flex grow items-center">
          <ul
            class="splide__pagination splide__pagination--custom w-full flex grow items-center gap-3"
          />
        </div>
        <div class="splide__arrows">
          <button class="splide__arrow splide__arrow--prev">
            <div
              class="bg-grayscale-50 w-[43.88px] aspect-square rounded-full"
              :class="{ 'bg-grayscale-500/50': activeIndex === 0 }"
              :style="{
          ...
          <button class="splide__arrow splide__arrow--next">
            <div
              class="bg-grayscale-50 w-[43.88px] aspect-square rounded-full"
              :class="{ 'bg-grayscale-500/50': activeIndex === slides.length - 1 }"
              :style="{
