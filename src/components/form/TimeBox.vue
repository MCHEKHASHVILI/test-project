...
<template>
    <div class="w-full flex flex-row justify-between gap-1.5">
        <label v-for="option in options" :key="option.id" class="grow cursor-pointer">
            ...
            <div
                class="p-3.75 aspect-163/61 flex-1 flex items-center justify-center gap-1 border border-grayscale-200 bg-grayscale-50 rounded-xl text-grayscale-800
                peer-checked:bg-purple-100 peer-checked:border-purple-300 peer-checked:text-purple-500
                 peer-enabled:hover:bg-purple-100 peer-enabled:hover:border-purple-300 peer-enabled:hover:text-purple-500
