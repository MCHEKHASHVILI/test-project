      ...
      <div class="w-full flex flex-row items-center justify-start space-x-2">
        <div class="w-full flex flex-row items-center justify-start space-x-2">
          <Transition
            ...
            leave-active-class="duration-300 ease-in overflow-hidden"
          ...
          >
            <BaseIcon
              ...
              :class="[
                props.panel.opened
                  ? '[&_path]:fill-grayscale-950 text-grayscale-50'
                  : 'text-grayscale-400',
              ]"
            />
          </Transition>
          <h3
            class="text-[24px] font-semibold text-purple-800 leading-6 transition-all duration-300 ease-in-out"
