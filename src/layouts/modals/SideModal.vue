...
<template>
    <Teleport to="body">
        <aside v-if="isOpen"
            :class="['fixed inset-0 z-50 flex items-start justify-end bg-black/25 backdrop transform transition-transform duration-600 ease-out', isOpen ? 'translate-x-0' : '-translate-x-full']">
            <div ref="modalRef"
                ...
                <div class="flex flex-col h-200 min-h-[calc(100vh-100px)]">
                    <div class="flex flex-row justify-between items-center">
                        <h2 class="text-heading-1 leading-11 text-grayscale-900 capitalize">enrolled courses</h2>
