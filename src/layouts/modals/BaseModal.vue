  ...
  <Teleport to="body">
    ...
    >
      <div v-if="isOpen" class="fixed inset-0 z-50 flex items-center justify-center bg-black-light">
        <div
          class="relative bg-grayscale-50 rounded-lg max-w-125 p-12.5 w-full transform transition-all"
          ref="modalRef"
        >
          <div class="absolute top-8 left-0 px-8 w-full h-auto">
            <div class="flex flex-row justify-between">
              ...
              <div class="shrink">
                <slot name="exit">
                  <button
                    class="cursor-pointer text-[13.2px] text-grayscale-400"
                    @click="$emit('close')"
                  >
          ...
          <div class="flex flex-col">
            <div class="flex flex-col">
              ...
              <div v-if="title" class="flex flex-row items-center justify-around">
                <h2
                  class="text-[32px] text-grayscale-900 font-semibold capitalize"
                  v-text="title"
                />
              </div>
