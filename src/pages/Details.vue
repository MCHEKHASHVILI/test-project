    ...
    <div class="flex flex-row items-start justify-between">
      <article class="w-225 flex flex-col gap-4.5">
        <div class="w-full h-120 rounded-[10px]">
          <img :src="getCourseDetailed.image" alt="Course Image" class="w-full h-full object-cover rounded-[10px]" />
        </div>
          ...
          <label class="box-border inline-flex items-center ">
            <div class="w-fit flex flex-row space-x-2.5 items-center bg-grayscale-50 rounded-xl py-2 px-3">
              <div class=" w-7.5 h-7.5 rounded-sm overflow-hidden">
                <img :src="getCourseDetailed.instructor.avatar" class="w-full h-full rounded-sm object-cover" />
              </div>
        ...
        <article class="flex flex-col gap-4">
          ...
          <p class="text-md font-medium text-grayscale-600" v-text="getCourseDetailed.description" />
        </article>
      </article>
      <section class="w-140">
